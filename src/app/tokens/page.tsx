                  ...
                  <tr key={token.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-bold text-gray-900">{token.name}</div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-semibold text-gray-900">{token.creator.name}</div>
                          <div className="flex items-center gap-1 mt-0.5">
                            ...
                            <span className="text-xs text-gray-500">{token.creator.twitterFollowers}</span>
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span className="text-xs text-gray-700 bg-gray-100 px-3 py-1.5 rounded-md font-medium">
                        {token.mintEvent}
                      </span>
                    </td>
                  </tr>
